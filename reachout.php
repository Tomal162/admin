...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "insert into address (title, address, link,  phone, email) values ('$title', '$address', '$link', '$phone', '$email')";

    if (mysqli_query($con, $query)) {
        // Redirect to the same page to prevent form resubmission and show a success message
        echo "<script>window.location.href = 'reachout.php';</script>";
    } else {
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        <div class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="flex items-center text-sm ml-4">
                <li class="mr-2">
                    <a href="#" class="text-gray-400 hover:text-gray-600 font-medium">Reach out</a>
                </li>
            </ul>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-xl font-semibold mb-4">Update Organization Address</h2>
                <form method="post" onsubmit="showNotification(event, 'address-notification')">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Embedded Link</label>
                        <input type="text" id="link" name="link" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    <div class="mb-4">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1551.601834794548!2d91.83585555315292!3d22.340338423110712!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ad275955701491%3A0x7187efe2b64e576d!2sAndarkilla%20Shahi%20Jame%20Masjid%2C%20Chittagong!5e0!3m2!1sen!2sbd!4v1724084705175!5m2!1sen!2sbd" width="1010" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Phone</label>
                        <input type="text" name="phone" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="text" name="email" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700">Update</button>
                </form>
                <div id="address-notification" class="hidden bg-green-500 text-white p-2 mt-4 rounded">Updated Successfully</div>
            </div>
    </main>
    <!-- end: Main Content -->
    <script>
